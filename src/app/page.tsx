...
/** =============================================
 * STALO ENGINEERING & CONSULTING (Primary)
 * + Design Build Florida (Optional GC/Install)
 * Single-file React (Next.js ready)
 * Tailwind + shadcn/ui + framer-motion
 * =============================================*/

/** PRIMARY SERVICES — handled by STALO (Engineering & CDs) */
const SERVICES_STALO = [
  {
    icon: <Ruler className="h-6 w-6" />,
    title: "Structural Engineering — STALO",
    points: [
...
/** OPTIONAL SERVICES — handled by Design Build Florida (GC/Install) */
const SERVICES_DBF = [
  {
...
/** Portfolio — existing images remain as‑is */
const PORTFOLIO = [
...
const BADGES = [
  {
    label: "Florida PE",
    sub: "STALO Engineering & Consulting — Professional Engineer",
...
const NAV = [
  ...
  { label: "GC / Install (DBF — Optional)", href: "#services-dbf" },
...
export default function Site() {
  const [form, setForm] = useState({
    ...
    email: "",
    phone: "",
    team: "STALO Engineering & Consulting",
    service: "",
    message: "",
  });
    ...
    <div className="min-h-screen bg-white text-neutral-800">
        ...
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <svg viewBox="0 0 24 24" className="h-7 w-7 text-neutral-900">
              <path d="M4 10l8-8 8 8-8 8-8-8z" fill="currentColor" />
            </svg>
            <div>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <Button asChild className="rounded-2xl">
              <a href="#contact">Request Engineering Quote</a>
            </Button>
          </nav>
        </div>
      </header>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-neutral-700 leading-relaxed">
              We provide <strong>stand‑alone</strong> structural engineering and
              <strong> permit‑ready construction documents</strong> across Florida — FBC 2023, ASCE 7‑22, including HVHZ.
              You don’t need to build with us to engage our engineering or CDs.
            </p>

            <div className="mt-4 flex items-start gap-3 rounded-2xl border border-neutral-200 bg-white p-3 text-sm text-neutral-700">
              <Info className="h-4 w-4 mt-0.5" />
              <div>
                <strong>Optional:</strong> General contracting & installation are available via{" "}
                <a href="#services-dbf" className="underline font-medium">Design Build Florida (DBF)</a> when the project needs it.
              </div>
            </div>

            <div className="mt-6 flex flex-wrap items-center gap-3">
              <Button asChild className="rounded-2xl">
                <a href="#services-stalo">Explore STALO Services</a>
              </Button>
              <Button variant="outline" asChild className="rounded-2xl">
                <a href="#services-dbf" className="flex items-center">
                  Optional GC/Install (DBF) <ChevronRight className="ml-1 h-4 w-4" />
                </a>
              </Button>
            </div>
          ...
          <div className="relative">
            <div className="aspect-[4/3] w-full rounded-3xl bg-neutral-200 shadow-inner overflow-hidden">
              <img
                ...
                alt="STALO Engineering — modular/CFS project"
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <h2 className="text-3xl font-bold tracking-tight text-neutral-900">
                STALO Engineering & Consulting — Engineering & Construction Documents
              </h2>
              <p className="mt-2 text-neutral-600">
                Primary offering. Permit‑ready, signed & sealed deliverables. Available stand‑alone.
              </p>
            </div>
            <span className="hidden md:inline-block text-xs bg-neutral-900 text-white px-3 py-1 rounded-full">
              Stand‑Alone Service
            </span>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-3 text-neutral-700">
              <strong>STALO Engineering & Consulting</strong> delivers structural engineering,
              sealed construction documents, shop drawings, and CNC outputs. These
              services are offered <strong>stand‑alone</strong>—engage us for engineering/CDs even if
              you plan to build with others. <strong>Design Build Florida (DBF)</strong> provides
              Florida CGC services for permitting, installation, and site execution
              <em> when needed</em>.
            </p>
          </div>
      ...
      <section className="border-t border-neutral-200 bg-neutral-900 text-white">
        <div className="mx-auto max-w-7xl px-4 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-2xl font-bold">Need signed & sealed CDs this month?</h3>
            <p className="text-neutral-300 mt-1">
              STALO handles engineering and permit‑ready packages. DBF is optional for install.
            </p>
          </div>
            ...
            <CardContent>
              {sent ? (
                <div className="text-green-700 text-sm">
                  ...
                  form to Formspree or your backend to start receiving submissions.
                </div>
              ) : (
                <form action="https://formspree.io/f/mdkljnde" method="POST" className="space-y-4">
                  <input type="hidden" name="_subject" value="New request — STALO × DBF" />
      ...
      <footer className="border-t border-neutral-200 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-4 py-10 grid md:grid-cols-3 gap-8 text-sm">
          <div>
            <div className="font-semibold">STALO Engineering & Consulting</div>
            <div className="text-neutral-600 mt-1">
              Florida PE. Engineering & permit‑ready construction documents.
            </div>
            <div className="text-neutral-600 mt-1">
              Optional GC/Install by Design Build Florida (Florida CGC).
            </div>
          </div>
          <div>
            <div className="font-semibold">STALO — Primary</div>
          ...
          <div>
            <div className="font-semibold">DBF — Optional GC / Install</div>
            <ul className="mt-2 space-y-1 text-neutral-700">
        ...
        <div className="border-t border-neutral-200 py-4 text-center text-xs text-neutral-500">
          © {new Date().getFullYear()} STALO Engineering & Consulting. All rights reserved.
        </div>
      </footer>
    </div>
  );
...
function SEO() {
  ...
  const jsonLd = {
    ...
    department: [
      {
        "@type": "LocalBusiness",
        name: "STALO Engineering & Consulting (Engineering & CDs)",
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="STALO provides stand‑alone structural engineering and permit‑ready construction documents across Florida (FBC 2023, ASCE 7‑22, HVHZ). Optional GC/Install by Design Build Florida."
      />
